...
func (s *MockStorage) Status(ctx context.Context, volId string) (*csi.VolumeCondition, error) {
	return &csi.VolumeCondition{Abnormal: false, Message: "All replicas normal"}, nil
}
