...
func (_m *VendorProvider) CreateExosEnclosure(ctx context.Context, enclosure client.ExosEnclosure) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateExosEnclosure")
	}
...
func (_m *VendorProvider) DeleteExosEnclosure(ctx context.Context, name string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for DeleteExosEnclosure")
	}
...
func (_m *VendorProvider) GetExosConnectionMap(ctx context.Context) (client.ExosConnectionMap, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetExosConnectionMap")
	}

	var r0 client.ExosConnectionMap
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (client.ExosConnectionMap, error)); ok {
		return rf(ctx)
	}
...
func (_m *VendorProvider) GetExosDefaults(ctx context.Context) (client.ExosDefaults, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetExosDefaults")
	}

	var r0 client.ExosDefaults
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (client.ExosDefaults, error)); ok {
		return rf(ctx)
	}
...
func (_m *VendorProvider) GetExosEnclosures(ctx context.Context, noCache bool) ([]client.ExosEnclosure, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetExosEnclosures")
	}

	var r0 []client.ExosEnclosure
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, bool) ([]client.ExosEnclosure, error)); ok {
		return rf(ctx, noCache)
	}
...
func (_m *VendorProvider) GetExosEvents(ctx context.Context, name string, count int32) ([]client.ExosEnclosureEvent, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetExosEvents")
	}

	var r0 []client.ExosEnclosureEvent
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int32) ([]client.ExosEnclosureEvent, error)); ok {
		return rf(ctx, name, count)
	}
...
func (_m *VendorProvider) ModifyExosDefaults(ctx context.Context, defaults client.ExosDefaultsModify) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for ModifyExosDefaults")
	}
...
func (_m *VendorProvider) ModifyExosEnclosure(ctx context.Context, name string, enclosure client.ExosEnclosure) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for ModifyExosEnclosure")
	}
...
func NewVendorProvider(t interface {
	mock.TestingT
	Cleanup(func())
}) *VendorProvider {
	mock := &VendorProvider{}
