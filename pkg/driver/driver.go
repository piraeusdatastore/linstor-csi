...
// GetPluginCapabilities https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#getplugincapabilities
...
// Probe https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#probe
func (d Driver) Probe(ctx context.Context, req *csi.ProbeRequest) (*csi.ProbeResponse, error) {
	return &csi.ProbeResponse{}, nil
}

// NodeStageVolume https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#nodestagevolume
func (d Driver) NodeStageVolume(ctx context.Context, req *csi.NodeStageVolumeRequest) (*csi.NodeStageVolumeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "")
}

// NodeUnstageVolume https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#nodeunstagevolume
func (d Driver) NodeUnstageVolume(ctx context.Context, req *csi.NodeUnstageVolumeRequest) (*csi.NodeUnstageVolumeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "")
}

// NodePublishVolume https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#nodepublishvolume
...
// NodeUnpublishVolume https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#nodeunpublishvolume
...
// NodeGetVolumeStats https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#nodegetvolumestats
...
// NodeGetCapabilities https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#nodegetcapabilities
...
// NodeGetInfo https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#nodegetinfo
...
// CreateVolume https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#createvolume
...
// DeleteVolume https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#deletevolume
...
// ControllerPublishVolume https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#controllerpublishvolume
...
// ValidateVolumeCapabilities https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#validatevolumecapabilities
...
// ControllerGetCapabilities https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#controllergetcapabilities
...
// CreateSnapshot https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#createsnapshot
...
// ListSnapshots https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#listsnapshots
...
// NodeExpandVolume https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#nodeexpandvolume
...
// ControllerExpandVolume https://github.com/container-storage-interface/spec/blob/v1.6.0/spec.md#controllerexpandvolume
