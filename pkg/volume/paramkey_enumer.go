...
const _paramKeyName = ""

var _paramKeyIndex = [...]uint16{0, 23, 32, 42, 61, 80, 99, 109, 115, 124, 133, 141, 155, 170, 189, 203, 210, 221, 237, 250, 260, 273, 293, 310, 324, 338, 347}

const _paramKeyLowerName = ""
...
var _paramKeyNameToValueMap = map[string]paramKey{
	...
	_paramKeyName[324:338]:      nfsservicetype,
	_paramKeyLowerName[324:338]: nfsservicetype,
	_paramKeyName[338:347]:      nfssquash,
	_paramKeyLowerName[338:347]: nfssquash,
}
...
var _paramKeyNames = []string{
	...
	_paramKeyName[324:338],
	_paramKeyName[338:347],
}
